...
function Hero() {
  return (
    <div
      className="
        w-full h-[70vh] bg-black bg-image"
    >
      <div className="container h-full mx-auto flex items-center">
        <div className="w-auto md:px-4 md:w-[70%] lg:w-[40%] text-white">
          ...
          <button className="bg-white mt-16 px-8 py-4 rounded-4xl text-black text-2xl cursor-pointer hover:bg-pink-600 transition duration-300">
            Learn More
          </button>
        </div>
      </div>
